...
func _on_line_edit_user_text_submitted(new_text):
	var label = $Label_prompt
	if new_text == "1500": 
		label.text = "BA: " + "600" + ";" + "Sz: " + "400" + "->" + "BA: " + new_text + "; Sz: "
		#get_tree().change_scene_to_file("res://Q1Sz2.tscn")
...
func print_question():
	return "BA: 600; Sz: 400 → BA: 1500; Sz: 700 → BA: 3600; Sz: 1500 → BA: 9200; Sz: 300
Use the next fit policy to update the list"
